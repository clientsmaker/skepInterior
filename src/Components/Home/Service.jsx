...
const Service = () => {
    return (
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-4 lg:gap-8 m-5 ">
            <div className="h-64 rounded-lg bg-gray-200 group block mb-14">
                <div className="relative h-[150px] sm:h-[450px] ">
                    <img
                        // src="https://images.unsplash.com/photo-1592921870789-04563d55041c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80"
                        src={ser1a}
                        alt=""
                        className="absolute inset-0 h-72 w-full sm:h-96 gap-1 object-cover opacity-100 group-hover:opacity-0 "
                    />
                    <img
                        ...
                        src={ser1b}
                        alt=""
                        className="absolute inset-0 h-72 w-full sm:h-96 gap-1 object-cover opacity-0 group-hover:opacity-100"
                    />
                </div>
            </div>
            <div className="h-64 rounded-lg bg-gray-200 group block mb-14 sm:mb-24">
                <div className="relative h-[150px] sm:h-[450px]">
                    <img
                        // src="https://images.unsplash.com/photo-1592921870789-04563d55041c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80"
                        src={ser2a}
