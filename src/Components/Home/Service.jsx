            ...
            <div className="h-64 rounded-lg bg-gray-200 group block mb-4">
                <div className="relative h-[150px] sm:h-[450px] ">
                    <img
                        ...
                        src={ser1a}
                        alt=""
                        className="absolute inset-0 h-72 w-full object-cover opacity-100 group-hover:opacity-0 "
                    />
                    <img
                        ...
                        src={ser1b}
                        alt=""
                        className="absolute inset-0 h-72 w-full object-cover opacity-0 group-hover:opacity-100"
                    />
                </div>
            </div>
            <div className="h-64 rounded-lg bg-gray-200 group block mb-4">
